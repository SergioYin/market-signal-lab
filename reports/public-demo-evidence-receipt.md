...
1. Open reports/index.html.
2. Open reports/public-demo-evidence-receipt.md and compare it with reports/public-demo-evidence-receipt.json.
3. Check fixture provenance files next to examples/data/*.csv before reading reported metrics.
4. Use the SHA-256 table as file-byte evidence for checked-in public artifacts only.
5. Run python scripts/selfcheck.py for local regeneration and link/boundary checks.

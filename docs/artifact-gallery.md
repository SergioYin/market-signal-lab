...
3. Regenerates the sample report, pre-trade packet, scenario card, beginner backtest-reading checklist, prediction-readiness audit, manifest, sweep, split-sweep, fee sensitivity, cross-asset thesis ledger, thesis-ledger acceptance, regime comparison, JSON, and HTML artifacts under `reports/`.

...
For methodology review, use the [Methodology Audit](methodology-audit.md) or generated [methodology audit template](../reports/methodology-audit-template.md) to check whether the sample backtest surfaces common beginner risks: look-ahead bias, survivorship bias, overfitting, fees and slippage, daily reset leveraged ETF-like risk, and no-advice/no-live-trading boundaries.
...
3. Use the [Methodology Audit](methodology-audit.md) or [generated methodology audit template](../reports/methodology-audit-template.md) as a PASS/WARN/FAIL checklist for common sample-backtest pitfalls.

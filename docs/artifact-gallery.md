...
For methodology review, use the [Methodology Audit](methodology-audit.md), generated [methodology audit template](../reports/methodology-audit-template.md), example [methodology audit score](../reports/methodology-audit-score.md), or [HTML methodology audit score](../reports/methodology-audit-score.html) to check whether the sample backtest surfaces common beginner risks: look-ahead bias, survivorship bias, overfitting, fees and slippage, daily reset leveraged ETF-like risk, and no-advice/no-live-trading boundaries.
...
3. Use the [Methodology Audit](methodology-audit.md), [generated methodology audit template](../reports/methodology-audit-template.md), [example methodology audit score](../reports/methodology-audit-score.md), or [HTML methodology audit score](../reports/methodology-audit-score.html) as a PASS/WARN/FAIL checklist for common sample-backtest pitfalls.
